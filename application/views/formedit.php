		...
		<div class="form-input clearfix">
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Edit Data Sewa</div>
					<div class="panel-body">
						...
						<?php echo form_open('home/updatemobil/'.$db->kdmobil, ['class' => 'form-horizontal', 'method' => 'post']); ?>
							<div class="form-group <?php echo (form_error('kdmobil') != '') ? 'has-error has-feedback' : '' ?>">
								<label for="kdmobil" class="control-label col-sm-2">Kode </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label for="nopol" class="control-label col-sm-2">No KB </label>
								<div class="col-sm-10">
